...
describe("wgs84tobd09", () => {
  ...
  it("[116.407526, 39.90403]", () => {
    let wgs84 = [116.407526, 39.90403];
    let bd09 = wgs84tobd09(wgs84[0], wgs84[1]);
...
describe("bd09_back_to_wgs84", () => {
  it("1", () => {
    let wgs84 = [116.407526, 39.90403]; // 北京的WGS84坐标
    let bd09 = wgs84tobd09(wgs84[0], wgs84[1]);
    let bd09_back_to_wgs84 = bd09towgs84(bd09[0], bd09[1]);
